...
\item
  ...
  had to work with.
\item
  \textbf{Hortaçsu and Syverson (2004), \emph{Quarterly Journal of
...
utility. The second, due to Chung et al. (2025), drops \(\mu_{itj}\) and
...
to estimate; Chung et al. (2025) show that relative preference
...
on Choice: How Do Consumers Search for Cameras Online?''} \emph{Journal
...
Satisficing.''} \emph{American Economic Review}.
...
Boundedly Rational Model.''} \emph{American Economic Review}.
...
Hauser, John R. 2014. {``Consideration-Set Heuristics: Review and
Research Agenda.''} \emph{Journal of Business Research}.
...
Estimate Search Costs.''} \emph{The RAND Journal of Economics}.

\bibitem[\citeproctext]{ref-Honka_2014}
Honka, Elisabeth. 2014. {``Quantifying Search and Switching Costs in the
{US} Auto Insurance Industry.''} \emph{The RAND Journal of Economics}.

\bibitem[\citeproctext]{ref-Honka_Chintagunta_2017}
Honka, Elisabeth, and Pradeep Chintagunta. 2017. {``Simultaneous or
Sequential? Search Strategies in the {US} Auto Insurance Industry.''}
\emph{Marketing Science}.

\bibitem[\citeproctext]{ref-Hortacsu_Syverson_2004}
Hortaçsu, Ali, and Chad Syverson. 2004. {``Product Differentiation,
Search Costs, and Competition in the Mutual Fund Industry: A Case Study
of {S\&P} 500 Index Funds.''} \emph{The Quarterly Journal of Economics}.

\bibitem[\citeproctext]{ref-Kim_2010}
Kim, Jun B., Paulo Albuquerque, and Bart J. Bronnenberg. 2010. {``Online
Demand Under Limited Consumer Search.''} \emph{Marketing Science}.
...
\emph{The Quarterly Journal of Economics}.

\bibitem[\citeproctext]{ref-Meissner_2016}
Meißner, Martin, Andrés Musalem, and Joel Huber. 2016. {``Eye Tracking
Reveals Processes That Enable Conjoint Choices to Become Increasingly
Efficient with Practice.''} \emph{Journal of Marketing Research}.
...
Ursu, Raluca M., Qianyun Wang, and Pradeep K. Chintagunta. 2020.
{``Search Duration.''} \emph{Marketing Science}.
...
\emph{Quantitative Marketing and Economics}, ahead of print.
...
Yang, Liu, Olivier Toubia, and Martijn G. de Jong. 2015. {``A Bounded
Rationality Model of Information Search and Choice in Preference
Measurement.''} \emph{Journal of Marketing Research}.

\bibitem[\citeproctext]{ref-Yang_2018}
Yang, Liu, Olivier Toubia, and Martijn G. de Jong. 2018. {``Attention,
Information Processing, and Choice in Incentive-Aligned Choice
Experiments.''} \emph{Marketing Science}.
...
{``Greedoid-Based Noncompensatory Inference.''} \emph{Marketing
Science}.

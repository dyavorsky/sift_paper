...
arise. On measured per-evaluation costs, full HB is the \emph{cheaper}
of the two routes at SIFT's dimensions, not the fallback. We therefore
treat HB as the primary estimator and empirical Bayes as the robustness
check.
